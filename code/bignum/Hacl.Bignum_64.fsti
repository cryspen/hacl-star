...
Comment "Heap-allocate and initialize a montgomery context.
  ...
  The caller will need to call Hacl_Bignum_64_mont_ctx_free on the return value
  to avoid memory leaks."]
val mont_ctx_init: len:BN.meta_len t_limbs -> MA.bn_field_init_st t_limbs len

[@@ Comment "Deallocate the memory previously allocated by Hacl_Bignum_64_mont_ctx_init.

  The argument k is a montgomery context obtained through Hacl_Bignum_64_mont_ctx_init."]
