...
Comment "Heap-allocate and initialize a montgomery context.
  ...
  The caller will need to call Hacl_Bignum_32_256bit_mont_ctx_free on the return value
  to avoid memory leaks."]
val mont_ctx_init: MA.bn_field_init_st t_limbs n_limbs

[@@ Comment "Deallocate the memory previously allocated by Hacl_Bignum_32_256bit_mont_ctx_init.

  The argument k is a montgomery context obtained through Hacl_Bignum_32_256bit_mont_ctx_init."]
